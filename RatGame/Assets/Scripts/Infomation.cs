...
public class Infomation : MonoBehaviour
{
    ...
    public Transform Potion_Dic_Panel;
    ...
    public void ShowInfo(bool isdic, ItemClass item)
    {
        ...
        if (iteminfo.itemType == ItemType.Herb) //아이템 타입 판별
        {
            //허브 아이템 정보 갱신 및 적용
        ...
        else
        {
            ...
            if (isdic)
            {
                ...
                if (openper < 30)
                {
                    Potion_Dic_SolidIcon.color = Color.black;
                    Potion_Dic_LiquidIcon.color = Color.black;
                }
                else
                {
                    Potion_Dic_SolidIcon.color = Color.white;
                    Potion_Dic_LiquidIcon.color = Color.white;
                }
                ...
                if (openper >= 70)
                {
                    Potion_Dic_Herb1Icon.transform.parent.gameObject.SetActive (true);
                    Potion_Dic_Herb1Icon.transform.parent.gameObject.SetActive (true);
                ...
                {
                    Potion_Dic_Herb1Icon.transform.parent.gameObject.SetActive(false);
                    Potion_Dic_Herb2Icon.transform.parent.gameObject.SetActive(false);
                }
        ...
        LayoutRebuilder.ForceRebuildLayoutImmediate(Herb_Name.transform.parent.GetComponent<RectTransform>());
        LayoutRebuilder.ForceRebuildLayoutImmediate(Herb_Name.transform.parent.parent.GetComponent<RectTransform>());
        LayoutRebuilder.ForceRebuildLayoutImmediate(Potion_Name.transform.parent.GetComponent<RectTransform>());
        LayoutRebuilder.ForceRebuildLayoutImmediate(Potion_Name.transform.parent.parent.GetComponent<RectTransform>());
    }

    public void PotionPanelOnOff()
    {
        Potion_Dic_Panel.gameObject.SetActive(!Potion_Dic_Panel.gameObject.activeSelf);
    }
}
